...
func bird_movement(click_channel chan int){
	...
	for{
		...
		fmt.Println("Typ von x:", reflect.TypeOf(duration))
		fmt.Println(duration)
		fmt.Println("This function took", duration, "time")
		durationInMilliseconds := duration.Milliseconds()
		fmt.Println(durationInMilliseconds)
		fmt.Println("Typ von durationInMilliseconds:", reflect.TypeOf(durationInMilliseconds))
		durationInNanoseconds := duration.Microseconds()
		fmt.Println(durationInNanoseconds)
		fmt.Println("Typ von durationInMilliseconds:", reflect.TypeOf(durationInNanoseconds))
